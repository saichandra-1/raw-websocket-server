...
// Use the PORT environment variable provided by Railway, fallback to 3001 for local dev
const PORT = process.env.PORT || 3001;

// Create WebSocket server, binding to 0.0.0.0 to accept external connections
